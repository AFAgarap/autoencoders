...
"""PyTorch implementation of mini VGG-based autoencoder"""
...
class Encoder(nn.Module):
    def __init__(self):
        ...
        self.conv1_layer_1 = nn.Conv2d(
            in_channels=1, out_channels=32, kernel_size=3, stride=(1, 1)
        )
...
class Decoder(nn.Module):
    def __init__(self):
        ...
        self.convt2_layer_2 = nn.ConvTranspose2d(
            in_channels=32, out_channels=1, kernel_size=3, stride=(1, 1)
        )
